...
TRUSTED_TASK_WARNING = (
    ...
    "вопросов. Команды разработчика по умолчанию заблокированы до подключения ОС-песочницы. "
    "Если вручную включён legacy-режим, запускаемый код работает с правами вашей учётной записи "
    "Windows, поэтому включайте этот режим только для полностью понятной задачи. "
    "Вы осознанно принимаете ответственность за "
