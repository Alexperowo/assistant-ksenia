...
- [ ] Реализовать независимый фоновый поиск параллельно с разговором (C4, дефект F02 / P0).
  Сейчас голосовой цикл синхронно ждёт session.ask. Нужна изолированная фоновая задача
  с собственным TaskControl и диспетчером озвучивания.
