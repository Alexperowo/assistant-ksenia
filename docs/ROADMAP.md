...
- [ ] Завершить fast-tier UI acceptance: 20–30 read-only UI шагов на разных приложениях/масштабах; затем один подтверждённый action только через существующие `windows_*` tools и Permission Broker. Runtime coordinator и ScreenCaptureService уже готовы. Baselines: `docs/FAST-RESIDENT-MODELS-BASELINE-2026-08-31.md`, `docs/SCREEN-CAPTURE-BASELINE-2026-08-31.md`.
