...
- [x] 407 автоматических тестов, контроль количества и предупреждений, три случайных порядка, полный контракт ярлыков, performance tracing, tool lifecycle/cancellation, fast resident tier, доступный атомарный fail-closed выбор микрофона, единый near-end capture worker, runtime cache/profiles и регрессии запрета модельного/машинного хардкода.
